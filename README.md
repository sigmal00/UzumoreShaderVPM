...
1. VCCを開き、**Setting → Packages → Add Repository**と選択し、`https://sigmal00.github.io/UzumoreShaderVPM/index.json`と入力してAddを選択

![image](https://github.com/user-attachments/assets/c930162b-7e25-4f55-a1c7-e060fe08dec4)
![image](https://github.com/user-attachments/assets/7900e8c0-5613-4d8c-9065-1f4fe16fee54)

2. 続いてVCC上でシェーダーを追加したいプロジェクトの"Manage Project"を選択
...
* ver1.0.20以降では**マテリアルを右クリックして"UzumoreShader/Copy & Convert material to UzumoreShader"を選択**することで元のマテリアルを残したままマテリアルを変換できます。

![image](https://github.com/user-attachments/assets/9f578c68-5b1e-4e25-825d-a336ea12ad54)
